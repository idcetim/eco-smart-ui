...
function App() {
    ...
    return ( <
        ...
        /> <
        Route path = "/celulosa"
        element = { < HomeCelulosa / > }
        /> <
        Route path = "/celulosa/origen/*"
        element = { < Origen / > }
        /> <
        Route path = "/celulosa/procesos/*"
        element = { < Procesos / > }
        /> <
        Route path = "/celulosa/producto/*"
        element = { < ProductoFinal / > }
        /> <
        Route path = "/celulosa/consulta/*"
        element = { < ConsultarCelulosa / > }
        /> <
        Route path = "/celulosa/consulta/lotes/*"
        element = { < ConsultarLotesCel / > }
        /> <
        Route path = "/silicio"
        element = { < HomeSilicio / > }
        /> <
        Route path = "/silicio/origen/*"
        element = { < LotesSilicio / > }
        /> <
        Route path = "/silicio/producto/*"
        element = { < ProductoSilicio / > }
        /> <
        Route path = "/silicio/consulta/*"
        element = { < ConsultarLoteSilicio / > }
        /> <
        Route path = "/silicio/consulta/lotes/*"
        element = { < ConsultarTodosSilicio / > }
        /> <
        Route path = "/baterias"
        element = { < HomeBaterias / > }
        /> <
